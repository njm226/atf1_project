...
def simple_small(X_Y):
    ...
    rates = np.array([beta1, beta2, beta3, beta4, alpha1, alpha2, alpha3, alpha4, beta5, beta6], dtype=np.double)
    
    #start the loop
    Max_blue, Max_red, states, red = t_loop(duration, mt_region, positions, rates, global_mode)
    #print(len(states))
    ...
    # fig, ax = plt.subplots(figsize=(12,5)) # a new (quadratic) figure is generated
