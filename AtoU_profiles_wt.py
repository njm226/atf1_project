...
#parameters = [[30,170,4]]
parameters = [[8,32,0.2],[16,8,0.2],[6,38,0.4],[18,4,0.4]]
reps=10000
duration=201
t1 = time.time()
for p in parameters:
        ...
        # save state_list
        with open('gAtoU_wt_cenH_Atf1_250_S200_UtoS%5.1f_AtoU%5.1f_direct%5.1f.txt' %tuple(p), 'wb') as F:
            pickle.dump(cenH_total_wt, F)
            
        
        # save state_list
        with open('gAtoU_wt_EcoRV_Atf1_250_S200_UtoS%5.1f_AtoU%5.1f_direct%5.1f.txt' %tuple(p), 'wb') as F:
