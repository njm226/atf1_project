...
#    ymax = ymax[3:]
    ...
    if  b_s >= 5.7 and b_s <= 9.5: #mean: 7.6 (50% difference: 3.8 and 11.4) (25% difference: 5.7 and 9.5) (35% difference: 3.0 and 6.3)
    ...
    if b_m > 21.15 and b_m <= 35.25: #mean: 28.2 (50% difference: 14.1 and 42.3) (25% difference: 21.15 and 35.25)(35% difference: 11.1 and 23.1)
    ...
    if b_l > 10.35 and b_l <= 17.25: #mean: 13.8 (50% difference: 6.9 and 20.7) (25% difference: 10.35 and 17.25)(35% difference: 31.9 and 66.3)
