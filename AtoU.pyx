...
def t_loop(int duration, int[:] mt_region, int[:] positions, double[:] rates, int SAU, int atf1):
    ...
    # silencing_threshold
    cdef int threshold1 = 4#16
    cdef int threshold2 = 4#7
    ...
    while T <= duration:
        ...
        # if the spontaneous conversion-rate (direct conversion in special region of A to U) is chosen
             ...
             # if the nucleosome is within the special region (cenH) and in state A
             if pos_conv == 92 and nuc_conv == 1 and N==153:# pos_conv == 92 or 89
             #if pos_conv==93 and nuc_conv==1:
                 # the state of the nucleosome is changed to U
                     mt_region[pos_conv]=2
            
             # if the nucleosome is within the special region (cenH) and in state A
             elif pos_conv == 122 and nuc_conv == 1 and N==182:# pos_conv == 92 or 89
             #if pos_conv==93 and nuc_conv==1:
                 # the state of the nucleosome is changed to U
                     mt_region[pos_conv]=2
             ...
             if pos_conv == 102 and nuc_conv == 1 and N==153: #   elif pos_conv == 93
             ...
             elif pos_conv == 141 and nuc_conv == 1 and N==191: #   elif pos_conv == 93
             #if pos_conv==103 and nuc_conv==1:
                 # the state of the nucleosome is changed to U
                     mt_region[pos_conv]=2
                     
             elif pos_conv == 153 and nuc_conv == 1 and N==203: #   elif pos_conv == 93
             #if pos_conv==103 and nuc_conv==1:
                 # the state of the nucleosome is changed to U
                     mt_region[pos_conv]=2
