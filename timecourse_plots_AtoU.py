...
X_Y_atf1_on=[[153,60,80,1,0]] #X_Y_atf1_on=[[182,49,130,0]]
X_Y_atf1_off=[[153,60,80,1,1]] #X_Y_atf1_off=[[182,49,130,1]]
X_Y_atf1_BS1_on=[[153,60,80,1,2]] #X_Y_atf1_off=[[182,49,130,1]]
X_Y_atf1_on_AE28=[[153,60,80,1,3]] #X_Y_atf1_off=[[182,49,130,1]]
#X_Y_atf1_on_AE28=[[153,50,120,4]] #X_Y_atf1_off=[[182,49,130,1]]
...
# # save state_list
# with open('AtoU_Atf1_on_AtoU_60_UtoM_80_both_present(pos122_pos132)_S250_all.txt', 'wb') as F:
#     pickle.dump(EcoRV_total_small, F)
    
# # save state_list
# with open('AtoU_Atf1_off_AtoU_60_UtoM_80_both_deleted_S250_all.txt', 'wb') as F:
#     pickle.dump(EcoRV_total_m, F)
    
# # save state_list
# with open('AtoU_Atf1_on_AtoU_60_UtoM_80_one_present_(pos132)_S250_all.txt', 'wb') as F:
#     pickle.dump(EcoRV_total_l, F)
    
# # save state_list
# with open('AtoU_Atf1_on_AtoU_60_UtoM_80_one_present_(pos122)_S250_all.txt', 'wb') as F:
#     pickle.dump(EcoRV_total_max, F)
    


# # save state_list
# with open('cenH_AtoU_Atf1_on_AtoU_60_UtoM_80_both_present(pos122_pos132)_S250_all.txt', 'wb') as F:
#     pickle.dump(cenH_total_small, F)
    
# # save state_list
# with open('cenH_AtoU_Atf1_off_AtoU_60_UtoM_80_both_deleted_S250_all.txt', 'wb') as F:
#     pickle.dump(cenH_total_m, F)
    
# # save state_list
# with open('cenH_AtoU_Atf1_on_AtoU_60_UtoM_80_one_present_(pos132)_S250_all.txt', 'wb') as F:
#     pickle.dump(cenH_total_l, F)
    
# # save state_list
# with open('cenH_AtoU_Atf1_on_AtoU_60_UtoM_80_one_present_(pos122)_S250_all.txt', 'wb') as F:
...
# save state_list
with open('wt_AtoU_Atf1_on_AtoU_60_UtoM_80_both_present(pos92_pos102)_S250_all.txt', 'wb') as F:
    pickle.dump(EcoRV_total_small, F)
    
# save state_list
with open('wt_AtoU_Atf1_off_AtoU_60_UtoM_80_both_eleted_S250_all.txt', 'wb') as F:
    pickle.dump(EcoRV_total_m, F)
    
# save state_list
with open('wt_AtoU_Atf1_on_AtoU_60_UtoM_80_one_present(pos102)_S250_all.txt', 'wb') as F:
    pickle.dump(EcoRV_total_l, F)
    
# save state_list
with open('wt_AtoU_Atf1_on_AtoU_60_UtoM_80_one_present(pos92)_S250_all.txt', 'wb') as F:
    pickle.dump(EcoRV_total_max, F)
    
    

# save state_list
with open('wt_cenH_AtoU_Atf1_on_AtoU_60_UtoM_80_both_present(pos92_pos102)_S250_all.txt', 'wb') as F:
    pickle.dump(cenH_total_small, F)
    
# save state_list
with open('wt_cenH_AtoU_Atf1_off_AtoU_60_UtoM_80_both_eleted_S250_all.txt', 'wb') as F:
    pickle.dump(cenH_total_m, F)
    
# save state_list
with open('wt_cenH_AtoU_Atf1_on_AtoU_60_UtoM_80_one_present(pos102)_S250_all.txt', 'wb') as F:
    pickle.dump(cenH_total_l, F)
    
# save state_list
with open('wt_cenH_AtoU_Atf1_on_AtoU_60_UtoM_80_one_present(pos92)_S250_all.txt', 'wb') as F:
    pickle.dump(cenH_total_max, F)
...
ax1.plot(time,EcoRV_total_small, color='yellowgreen', label='mCherry wt: both atf1-sites present (pos 92 and pos 102)')
...
ax1.plot(time,EcoRV_total_l, color='grey', label='mCherry wt: one atf1-site deleted (at pos 92)')
ax1.plot(time,EcoRV_total_max, color='red', label='mCherry wt: one atf1-site deleted (at pos 102)')
...
plt.savefig("wt_AtoU_S250_AtoU_60_UtoS_80.pdf")
