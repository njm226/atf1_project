...
X_Y_atf1_BS1_on=[[182,49,125,2]] #X_Y_atf1_off=[[182,49,130,1]]
X_Y_atf1_on_AE28=[[182,49,125,3]] #X_Y_atf1_off=[[182,49,130,1]]
...
# save state_list
with open('AtoU_Atf1_on_S100_AtoU_49_UtoM_125_both_present_new.txt', 'wb') as F:
    pickle.dump(EcoRV_total_small, F)
    
# save state_list
with open('AtoU_Atf1_off_S100_AtoU_49_UtoM_125_both_deleted_new.txt', 'wb') as F:
    pickle.dump(EcoRV_total_m, F)
    
# save state_list
with open('AtoU_Atf1_off_S100_AtoU_49_UtoM_125_one_deleted(pos122_deleted)_new.txt', 'wb') as F:
    pickle.dump(EcoRV_total_l, F)
    
# save state_list
with open('AtoU_Atf1_off_S100_AtoU_49_UtoM_125_both_present_AE28.txt', 'wb') as F:
...
ax1.plot(time,EcoRV_total_small, color='red', label='mCherry ME2: both atf1-sites present (4.5 kb AE28)')
...
plt.savefig("AtoU_Atf1_S100_AtoU_49_UtoM_125_new_with_AE28.pdf")
