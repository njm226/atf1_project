...
# save state_list
with open('WT_AtoU_Atf1_on_S100_AtoU_49_UtoM_120_both_present_new_all_special_250.txt', 'wb') as F:
    pickle.dump(EcoRV_total_small, F)
    
# save state_list
with open('WT_AtoU_Atf1_off_S100_AtoU_49_UtoM_120_both_deleted_new_all_special_250.txt', 'wb') as F:
    pickle.dump(EcoRV_total_m, F)
    
# save state_list
with open('WT_AtoU_Atf1_off_S100_AtoU_49_UtoM_120_one_deleted(pos122_deleted)_new_all_special_250.txt', 'wb') as F:
...
# save state_list
with open('WT_cenH_AtoU_Atf1_on_S100_AtoU_49_UtoM_120_both_present_new_all_special_250.txt', 'wb') as F:
    pickle.dump(cenH_total_small, F)
    
# save state_list
with open('WT_cenH_AtoU_Atf1_off_S100_AtoU_49_UtoM_120_both_deleted_new_all_special_250.txt', 'wb') as F:
    pickle.dump(cenH_total_m, F)
    
# save state_list
with open('WT_cenH_AtoU_Atf1_off_S100_AtoU_49_UtoM_120_one_deleted(pos122_deleted)_new_all_special_250.txt', 'wb') as F:
...
plt.savefig("WT_AtoU_Atf1_S100_AtoU_50_UtoM_120_new_with_AE28_all_special_250.pdf")
