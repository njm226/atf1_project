...
for p in parameters:
        ...
        # save state_list
        with open('gAtoU_sizes_cenH_Atf1_250_S150_UtoS%5.1f_AtoU%5.1f_direct%5.1f.txt' %tuple(p), 'wb') as F:
            pickle.dump(cenH_total, F)
            
        
        # save state_list
        with open('gAtoU_sizes_EcoRV_Atf1_250_S150_UtoS%5.1f_AtoU%5.1f_direct%5.1f.txt' %tuple(p), 'wb') as F:
