...
for p in parameters:
        ...
        X_Y_atf1_off=[[182,p[0],p[1],p[2],0]] #X_Y_atf1_off=[[182,49,130,1]]
        X_Y_atf1_BS1_on=[[191,p[0],p[1],p[2],0]] #X_Y_atf1_off=[[182,49,130,1]]
        X_Y_atf1_BS2_on=[[203,p[0],p[1],p[2],0]] #X_Y_atf1_off=[[182,49,130,1]]
        ...
        # save state_list
        with open('gAtoU_sizes_cenH_Atf1_250_S130_UtoS%5.1f_AtoU%5.1f_direct%5.1f_reactication_on.txt' %tuple(p), 'wb') as F:
            pickle.dump(cenH_total, F)
            
        
        # save state_list
        with open('gAtoU_sizes_EcoRV_Atf1_250_S130_UtoS%5.1f_AtoU%5.1f_direct%5.1f_reactication_on.txt' %tuple(p), 'wb') as F:
